...
const TERRAIN_METADATA = {
  ...
  BASALT_COLUMN_BARRIER: {
    ...
    speedMultiplier: 999, visibilityFactor: 0, baseInherentVisibilityBonus: -10, prominence: 0, canopyBlockage: 0,
    isImpassable: true, blocksLineOfSight: true,
  ...
  QUARTZ_CRYSTAL_SPINES: {
    ...
    speedMultiplier: 999, visibilityFactor: 0, baseInherentVisibilityBonus: -5, prominence: 0, canopyBlockage: 0,
    isImpassable: true, blocksLineOfSight: true,
  ...
  LIMESTONE_FLOWSTONE_WALL: {
    ...
    speedMultiplier: 999, visibilityFactor: 0, baseInherentVisibilityBonus: -2, prominence: 0, canopyBlockage: 5,
    isImpassable: true, blocksLineOfSight: true,
